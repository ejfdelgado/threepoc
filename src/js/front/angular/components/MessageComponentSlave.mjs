...
export class MessageComponentSlaveClass {
  constructor($scope) {
    this.$scope = $scope;
  }
  save() {
...
export const MessageComponentSlave = {
  bindings: {
    page: "<",
  },
  templateUrl: "/js/front/angular/components/MessageComponentSlave.html",
  controller: MessageComponentSlaveClass,
};
