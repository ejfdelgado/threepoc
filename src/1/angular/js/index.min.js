...
var _CalendarModule = require("../../../js/front/angular/modules/CalendarModule.mjs");

var _IdGen = require("../../../js/common/IdGen.mjs");
...
},{"../../../js/common/IdGen.mjs":2,"../../../js/front/angular/modules/CalendarModule.mjs":4}],2:[function(require,module,exports){
"use strict";
  ...
  static ahora() {
    return _asyncToGenerator(function* () {
      return new Promise(resolve => {
        var sincronizar = /*#__PURE__*/function () {
          var _ref = _asyncToGenerator(function* () {
            var response = yield fetch(IdGen.URL_GET_DATE, {
              method: "GET"
            });
            var rta = yield response.json();
...
_defineProperty(IdGen, "URL_GET_DATE", "/api/tup/fecha");
